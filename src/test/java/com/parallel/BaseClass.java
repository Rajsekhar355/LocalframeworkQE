...
public abstract class BaseClass {
	...
	public void printFailureLogAndReport(String className,Logger logger2, String data) {
	...
	public void printSuccessLogAndReport(String className,Logger logger2, String data) {
		ExtTest.getTest(className, "pass", data ).log(Status.PASS, data);
		
	}

	
	public void printValidateLogAndReport(String className,Logger logger, String data) throws Exception {
		logger.info(data);
		if(data.startsWith("Pass:")) {
			data = data.replace("Pass:", "");
			printSuccessLogAndReport(className, logger, data);
		} else {
			data = data.replace("Fail:", "");
			printFailureLogAndReport(className, logger, data);
		}
	}
